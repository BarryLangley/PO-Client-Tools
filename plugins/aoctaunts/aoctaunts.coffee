...
do ->
    ...
    checkTaunts = (verbose = yes) ->
        ...
        if verbose
            confetti.msg.bot "<a href='http://speedy.sh/n87QB/aoctaunts.zip'>AoC Taunts need to be downloaded</a> and placed in your PO directory (typically <i>C:\\Program Files (x86)\\Pokemon Online\\</i> on Windows). Copy the <i>aoctaunts</i> directory into your PO directory instead of simply extracting."
