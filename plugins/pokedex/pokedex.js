...
(function() {
  confetti.command('pokedex', ['pokedex [pok&eacute;mon?]', 'Shows a Pokédex entry for the given Pokémon, or a random one if none was given. This command will cause lag when first used in this session.', 'setmsg@pokedex [pokemon]'], function(data, chan) {
